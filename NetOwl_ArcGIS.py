...
if arcpy.Exists("netowl_fc") is False:
    arcpy.CreateFeatureclass_management(wk, "netowl_fc", "POINT", "netowl_template_fc", 'No', 'No', sr)  # noqa: E501
...
# for nongeo table
if arcpy.Exists("netowl_nogeo") is False:
    arcpy.CreateTable_management(wk, "netowl_nogeo", "netowl_template_nogeo")
...
if arcpy.Exists("netowl_links") is False:
    arcpy.CreateTable_management(wk, "netowl_links", "netowl_template_links")
